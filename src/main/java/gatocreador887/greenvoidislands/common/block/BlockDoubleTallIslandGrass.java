...
public class BlockDoubleTallIslandGrass extends BlockBush implements IGrowable, net.minecraftforge.common.IShearable {
	...
	public java.util.List<ItemStack> onSheared(ItemStack item, net.minecraft.world.IBlockAccess world, BlockPos pos, int fortune) {
		...
		if (type == EnumPlantType.FERN) {
			ret.add(new ItemStack(GVIBlockManager.TALL_ISLAND_GRASS, 2, BlockTallIslandGrass.EnumType.FERN.getMeta()));
		}
		if (type == EnumPlantType.GRASS) {
			ret.add(new ItemStack(GVIBlockManager.TALL_ISLAND_GRASS, 2, BlockTallIslandGrass.EnumType.GRASS.getMeta()));
		}
		return ret;
	}
	...
	public static enum EnumPlantType implements IStringSerializable {
		GRASS(0, "double_grass", "grass"), FERN(1, "double_fern", "fern");
