...
public class GVIItemManager {
	...
	public static final Item FOLIGENU_AND_OBSIDIAN = register(new ItemFoligenuAndObsidian(), new ResourceLocation(GVIReference.ID, "foligenu_and_obsidian"));
	...
	public static final Item SHRONK = register(new ItemShronk(), new ResourceLocation(GVIReference.ID, "shronk"));
	public static final Item RAW_SHRONKER = register(new ItemFood(3, 0.3F, true).setPotionEffect(new PotionEffect(MobEffects.HUNGER, 400, 1), 0.85F), new ResourceLocation(GVIReference.ID, "raw_shronker"));
	public static final Item COOKED_SHRONKER = register(new ItemFood(8, 0.8F, true), new ResourceLocation(GVIReference.ID, "cooked_shronker"));
	public static final Item SHRONKER_FEATHER = register(new Item(), new ResourceLocation(GVIReference.ID, "shronker_feather"));
