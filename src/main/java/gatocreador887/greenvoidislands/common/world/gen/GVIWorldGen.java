	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
		...
		switch (world.provider.getDimension()) {
			case 0: // Overworld
				...
				this.runGenerator(this.gen_foligenu_ore, world, random, chunkX, chunkZ, 4 + random.nextInt(2), 11, 53 + random.nextInt(3));
			...
			case 7: // Green Void Islands
				...
				// this.runGenerator(gen_gvi_foligenu_ore, world, random, chunkX, chunkZ, 5 +
				// random.nextInt(3), 0, 255);
