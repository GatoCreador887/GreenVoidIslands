package creepersgalore.greenvoidislands.common.world;
...
public class GVITeleporter extends Teleporter {
				...
				for (int i1 = -2; i1 <= 2; ++i1) {
					for (int j1 = -1; j1 < 3; ++j1) {
						...
						this.worldServerInstance.setBlockState(new BlockPos(k1, l1, i2),
								flag ? GVIBlockManager.foligenu_block.getDefaultState() : Blocks.AIR.getDefaultState());
					}
				}
			}
	...
	/**
	 * called periodically to remove out-of-date GVIBlockManager.gvi_portal locations from the
